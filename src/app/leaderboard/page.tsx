          ...
          <Card className="mb-6 border-4 border-primary bg-primary/10">
            <CardContent className="p-6 text-center">
              <div className="flex items-center justify-center mb-3">
                <span className="material-symbols-outlined text-4xl text-text">construction</span>
              </div>
              <h2 className="text-text text-xl sm:text-2xl font-display font-bold mb-2">
                Coming Soon
              </h2>
              <p className="text-accent font-mono text-sm max-w-md mx-auto">
                The leaderboard feature is currently under development. Check back soon to see rankings across your groups!
              </p>
            </CardContent>
          </Card>
